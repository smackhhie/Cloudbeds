...
package controller;
import view.saurav_view;
import javax.swing.JOptionPane;
import javax.swing.JComboBox;
import java.sql.*;
import javax.swing.JTextField;

public class saurav_Controller {
    private Connection conn;
    PreparedStatement pst;
    saurav_view view;
    
    public saurav_Controller( saurav_view view){
        this.view=view;
    }
public void populateRoomNumbers(JComboBox<String> combo) {
    ...
    public void refreshNames(int roomNumber, JTextField txt_Cname) {
