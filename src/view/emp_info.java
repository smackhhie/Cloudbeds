...
import controller.emp_infoController;
...
public class emp_info extends javax.swing.JFrame {
    ...
    public emp_info() {
     ...
     public emp_infomodel getUser(){
       ...
       model = new emp_infomodel(txtname.getText(),(String) txtselect.getSelectedItem(),salary.getText(),phone.getText(),citizenno.getText(),btnmale.getText(),btnfemale.getText(),btnothers.getText(),selectedValue);
       return model;
   }
    /**
...
boolean validation()
    ...
    private void btnupdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnupdateActionPerformed
        ...
        emp_infoController cont=new emp_infoController(this);
    }//GEN-LAST:event_btnupdateActionPerformed
}
    public void emp_infoListner(ActionListener log)
{
