...
import controller.Add_empController;
...
public class Add_emp extends javax.swing.JFrame {
   ...
   public Addempmodel getUser(){
       ...
       model = new Addempmodel(txtname.getText(),(String) txtselect.getSelectedItem(),salary.getText(),phone.getText(),citizenno.getText(),btnmale.getText(),btnfemale.getText(),btnothers.getText(),selectedValue);
       return model;
   }
...
//   }
    ...
    private void initComponents() {
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Untitled1.png"))); // NOI18N
...
Add_empController a=new Add_empController(this);
    
    }//GEN-LAST:event_btnsummitActionPerformed
    }
    public void Add_empListner(ActionListener log)
{
