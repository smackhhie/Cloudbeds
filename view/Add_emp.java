...
public class Add_emp extends javax.swing.JFrame {
   ...
   public Add_empmodel getUser(){
       ...
       model = new Add_empmodel(txtname.getText(),selectedValue,(String) txtselect.getSelectedItem(),salary.getText(),phone.getText(),citizenno.getText(),btnmale.getText(),btnfemale.getText(),btnothers.getText());
       return model;
   }
...
//   }
    ...
    private void initComponents() {
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/Untitled1.png"))); // NOI18N
